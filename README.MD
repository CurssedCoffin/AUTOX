...
是从 [7-Zip-zstd](https://github.com/mcmilk/7-Zip-zstd) 的 7z25.01-zstd-x64.exe 版本安装程序中提取的。

Tag为 [7-Zip ZS 25.01 - v1.5.7 - Release 1](https://github.com/mcmilk/7-Zip-zstd/releases/tag/v25.01-v1.5.7-R1)。
